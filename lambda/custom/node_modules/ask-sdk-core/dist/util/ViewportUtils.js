...
function getViewportSizeGroup(size) {
    ...
    throw ask_sdk_runtime_1.createAskSdkError('ViewportUtils.ts', 'unknown size group value ' + size)
}
...
function getViewportDpiGroup(dpi) {
    ...
    throw ask_sdk_runtime_1.createAskSdkError('ViewportUtils.ts', 'unknown dpi group value ' + dpi)
}
